...
const DEFAULT_KB = {
  ...
  phases: {
    '1': {
      ...
      keywords: ['phase 1', 'giai đoạn 1', 'thẩm định', 'giấy phép kinh doanh', 'gpkd', 'business license', 'compliance', 'khoa', 'khoaNVM', 'hungnq9'],
      action: { type: 'email', to: 'hungnq9@vng.com.vn', subject: '[Onboarding] Thẩm định Merchant' }
    },
    '2': {
      name: 'Review Hợp đồng',
      keywords: ['phase 2', 'giai đoạn 2', 'hợp đồng', 'contract', 'legal', 'luật', 'tuPNC', 'namnk'],
      action: { type: 'email', to: 'namnk@vng.com.vn', subject: '[Onboarding] Review Hợp đồng' }
    },
    '3': {
